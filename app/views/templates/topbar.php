...
?>
<!-- Topbar -->
<nav class="navbar navbar-expand navbar-light rounded bg-white topbar px-4 mb-4 static-top shadow-sm <?php echo $isPinjamPage ? 'justify-content-between' : 'justify-content-end'; ?>">
    ...
    <ul class="navbar-nav ml-auto d-flex align-items-center">
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdownMenuAvatar">
                <li>
                    <a class="dropdown-item" href="<?= BASEURL; ?>/profile"><i class="fa-regular fa-user"></i> My profile</a>
                </li>
                <li>
