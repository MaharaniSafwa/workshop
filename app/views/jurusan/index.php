                                ...
                                <td class="icon-container" style="text-align: center;">
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu" style="min-width: auto !important;">
                                            <li><a class="dropdown-item" href="<?= BASEURL; ?>/jurusan/ubah/<?= $jurusan['id_jurusan']; ?>" class="tombolEditJurusan" data-bs-toggle="modal" data-bs-target="#formModal" data-id="<?= $jurusan['id_jurusan']; ?>"><i class=" fa-solid fa-pen-to-square"></i>Edit</a></li>
                                            <li><a class="dropdown-item" href="<?= BASEURL; ?>/jurusan/hapus/<?= $jurusan['id_jurusan']; ?>" onclick="return confirm('yakin?');"><i class="fa-solid fa-trash-can"></i>Delete</a></li>
                                        </ul>
                                    </div>
