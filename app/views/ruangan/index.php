                                ...
                                <td class="icon-container text-center">
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu" style="min-width: auto !important;">
                                            <li><a class="dropdown-item" href="<?= BASEURL; ?>/ruangan/detail/<?= $ruangan['id_ruangan']; ?>"><i class="fa-regular fa-eye"></i>View</a></li>
                                            <li>
                                                <hr class="dropdown-divider">
                                            </li>
                                            <li><a class="dropdown-item" href="<?= BASEURL; ?>/ruangan/ubah/<?= $ruangan['id_ruangan']; ?>" class="tampilEditRuangan" data-bs-toggle="modal" data-bs-target="#formModal" data-id="<?= $ruangan['id_ruangan']; ?>"><i class=" fa-solid fa-pen-to-square"></i>Edit</a></li>
                                            <li><a class="dropdown-item" href="<?= BASEURL; ?>/ruangan/hapus/<?= $ruangan['id_ruangan']; ?>" onclick=" return confirm('yakin?');"><i class="fa-solid fa-trash-can"></i>Delete</a></li>
                                        </ul>
                                    </div>
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="preview rounded">
                                            ...
                                            <input type="file" id="thumbnail" class="form-control d-none" name="thumbnail" accept="image/*">
